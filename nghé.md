...
Ngoài ra, nếu muốn phát triển PricePilot tốt hơn, khóa sau có thể cải thiện phần elasticity bằng cách dùng nhiều điểm dữ liệu lịch sử hơn, hoặc tính elasticity riêng cho từng nhóm khách hàng hoặc từng loại sản phẩm. Như vậy recommendation sẽ sát thực tế hơn thay vì dùng một mức elasticity cố định cho toàn bộ mô phỏng.
